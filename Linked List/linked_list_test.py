...
class LinkedListTest(unittest.TestCase):
    ...
    def test_reverse(self):
        ...
        self.assertEqual(my_linked_list.length, 1)
        self.assertEqual(my_linked_list.head.value, 1)
        self.assertEqual(my_linked_list.tail.value, 1)
        my_linked_list.reverse()
        self.assertEqual(my_linked_list.length, 1)
        self.assertEqual(my_linked_list.head.value, 1)
        self.assertEqual(my_linked_list.tail.value, 1)
        ...
        my_linked_list.reverse()
        self.assertEqual(my_linked_list.length, 2)
        self.assertEqual(my_linked_list.head.value, 2)
        self.assertEqual(my_linked_list.tail.value, 1)
        my_linked_list.append(0)
        self.assertEqual(my_linked_list.length, 3)
        self.assertEqual(my_linked_list.head.value, 2)
        self.assertEqual(my_linked_list.tail.value, 0)
        self.assertEqual(my_linked_list.length, 3)
        my_linked_list.reverse()
    ...
    def test_all(self):
        ...
        self.assertEqual(my_linked_list.length, 3)
        self.assertEqual(my_linked_list.head.value, 1977)
        self.assertEqual(my_linked_list.tail.value, 21)
        my_linked_list.reverse()
        self.assertEqual(my_linked_list.get(0).value, 21)
        self.assertEqual(my_linked_list.get(1).value, 10)
        self.assertEqual(my_linked_list.get(2).value, 1977)
